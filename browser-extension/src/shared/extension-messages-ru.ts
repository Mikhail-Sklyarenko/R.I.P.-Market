...
export const extensionMessagesRu: ExtensionMessageTree = {
  ...
  popup: {
    ...
    receiptsSub: 'Краткий список · детали по клику',
  ...
  dispute: {
    ...
    openTitle: 'Спор уже у команды',
    openBody:
      'Ничего срочного с вашей стороны. Не принимайте другие офферы по этой сделке — решение примет поддержка или админ.',
