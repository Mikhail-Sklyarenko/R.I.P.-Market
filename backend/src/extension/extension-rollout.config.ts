...
export type ExtensionFeatureFlagSnapshot = {
  ...
  ENABLE_EXTENSION_UI_TRADE_FLOW: boolean;
  ENABLE_EXTENSION_TRADE_ACKNOWLEDGMENT: boolean;
  ENABLE_EXTENSION_INVENTORY_LAYER: boolean;
  ENABLE_EXTENSION_GUIDED_BUYER: boolean;
  ENABLE_EXTENSION_QUIET_NOTIFICATIONS: boolean;
...
export function snapshotExtensionFeatureFlags(): ExtensionFeatureFlagSnapshot {
  return {
    ...
    ENABLE_EXTENSION_UI_TRADE_FLOW:
