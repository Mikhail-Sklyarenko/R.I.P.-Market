...
export const ERROR_MESSAGES: Record<string, string> = {
  ...
  STEAM_RATE_LIMITED:
    'Steam ограничивает частоту запросов с сервера. Подождите 1–2 минуты и обновите, либо выставьте предмет из инвентаря Steam через расширение.',
  STEAM_ACCOUNT_CHANGED:
    'Steam-аккаунт сменился во время синхронизации. Обновите инвентарь ещё раз.',
