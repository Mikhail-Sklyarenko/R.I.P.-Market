...
export const clientExtraEn = {
  ...
  orderBook: {
    title: 'Order book',
    subtitle: 'Buy demand and top sell offers for this item.',
    loading: 'Loading order book…',
    empty: 'No buy or sell interest for this item yet.',
    spread: 'Spread',
    bidsTitle: 'Buyers',
    asksTitle: 'Sellers',
    noBids: 'No buy requests yet.',
    noAsks: 'No listings yet.',
    colPrice: 'Price',
    colQty: 'Qty',
    colFloat: 'Float',
    quantityShort: '{{count}} pcs',
    ownBadge: 'Yours',
    ownDemandNote: 'Your request is included in the demand shown below.',
    compactSubtitle: 'Buy demand for this wear.',
    demandLabel: 'Demand',
    bestBidLabel: 'Top bid',
    sellHint_one: '{{count}} buyer ready to pay up to',
    sellHint_few: '{{count}} buyers ready to pay up to',
    sellHint_many: '{{count}} buyers ready to pay up to',
    asksSummary: '{{count}} listings for sale',
    fromPrice: 'from',
    openLot: 'Open',
    sellHintPrefix: '{{count}} buyers ready to pay up to',
    sellLink: 'List from inventory',
  },
  buyRequestPanel: {
    kicker: 'Buy request',
    ...
    createdMinutesAgo: '{{count}} min ago',
    createdHoursAgo: '{{count}} h ago',
    createdDaysAgo: '{{count}} d ago',
  ...
  myBuyRequests: {
    ...
    emptyStep1: 'Find an item in the catalog.',
    emptyStep2: 'Set your max price and quantity.',
  ...
  notifications: {
    ...
    emptyFilteredTitle: 'No notifications match',
    emptyFilteredMessage: 'Reset filters — new events may be under another section.',
  ...
  readiness: {
    ...
    insufficientGeneric: 'Top up your USD balance to confirm the purchase.',
  ...
  wallet: {
    ...
    depositAwaiting: 'Waiting for the transfer… USD appears on your balance after confirmations on the TRON network.',
    ...
    realMoneyBetaTitle: 'Closed beta: real money',
    realMoneyBetaBody:
      'Deposits are paid in USDT on supported networks (mainnet). Your balance is credited in USD. Trades and seller payouts roll out in phases — funds on hold protect buyers until the Steam trade is confirmed.',
