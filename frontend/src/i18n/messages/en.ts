...
const baseEnMessages = {
  ...
  catalog: {
    ...
    emptyFilteredMessage: 'Reset filters or change your search — other listings may be available.',
    emptyCatalogTitle: 'No listings yet',
    emptyCatalogMessage:
      'There are no active lots right now. Check back later or list an item from your inventory.',
    emptyCatalogSell: 'List an item',
  ...
  lots: {
    ...
    emptyStep1: 'Open inventory and pick an item.',
    emptyStep2: 'Set a price and publish the listing.',
    emptyFilteredTitle: 'No listings match',
    emptyFilteredMessage: 'Reset search or status — your lots may be under another filter.',
  ...
  wallet: {
    ...
    transactionsEmptyMessage:
      'Deposit funds or make a purchase — credits and debits will show up here.',
    transactionsEmptyDeposit: 'Deposit',
  ...
  account: {
    ...
    identityAria: 'Profile',
    setupAria: 'Trading setup',
    readinessAria: 'Trading readiness',
    guestName: 'Account',
    adminChip: 'Admin',
    readinessSteamOk: 'Steam linked',
    readinessSteamNeed: 'Steam needed',
    readinessTradeUrlOk: 'Trade URL ready',
    readinessTradeUrlNeed: 'Trade URL needed',
    tradeUrlTitle: 'Trade URL',
    tradeUrlNeeded: 'Required for Steam trades — without it you cannot send or receive offers.',
    tradeUrlStatusReady: 'Ready',
    tradeUrlStatusNeed: 'Missing',
    ...
    getTradeUrl: 'Open in Steam',
    steamSectionTitle: 'Steam',
    steamCardLead: 'Inventory and deals are tied to this account.',
    steamStatusLinked: 'Linked',
    steamStatusNeed: 'Not linked',
    ...
    quickLinksLead: 'Catalog, inventory, and wallet — one click away.',
  ...
  lot: {
    ...
    sellerLabel: 'Seller',
    purchaseDetails: 'About this purchase',
  ...
  orders: {
    ...
    emptyFilteredTitle: 'No deals match',
    emptyFilteredMessage: 'Reset status or role — active deals may be under another filter.',
    resetStatusFilter: 'Reset filter',
