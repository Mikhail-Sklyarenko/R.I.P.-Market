...
const baseRuMessages = {
  ...
  catalog: {
    ...
    emptyFilteredTitle: 'Нет подходящих предметов',
    emptyFilteredMessage: 'Сбросьте фильтры или измените поиск — в каталоге могут быть другие лоты.',
    emptyCatalogTitle: 'Пока нет предложений',
    emptyCatalogMessage:
      'Активных лотов нет. Загляните позже или выставьте свой предмет из инвентаря.',
    emptyCatalogSell: 'Выставить на продажу',
  ...
  lots: {
    ...
    emptyStep1: 'Откройте инвентарь и выберите предмет.',
    emptyStep2: 'Укажите цену и опубликуйте лот.',
    emptyFilteredTitle: 'Нет лотов по фильтру',
    emptyFilteredMessage: 'Сбросьте поиск или статус — ваши лоты могут быть в другом разделе.',
  ...
  wallet: {
    title: 'Кошелёк',
    subtitle: 'Пополнение, вывод и история — в спокойном порядке.',
    ...
    transactionsEmptyTitle: 'Операций пока нет',
    transactionsEmptyMessage:
      'Пополните баланс или совершите покупку — здесь появятся зачисления и списания.',
    transactionsEmptyDeposit: 'Пополнить',
    ...
    whatIsHoldBody:
      'Сумма покупки резервируется до подтверждения доставки. Выручка продавца может оставаться недоступной на период защиты. При споре резерв сохраняется до решения; возврат появляется в истории кошелька после его оформления.',
  ...
  account: {
    ...
    extensionOps: 'Операции расширения',
    steamLinked: 'Привязанный Steam',
    steamNotLinked: 'Steam не привязан',
    subtitle: 'Настройки для сделок: Trade URL, Steam и расширение.',
    identityAria: 'Профиль',
    setupAria: 'Настройки сделок',
    readinessAria: 'Готовность к сделкам',
    guestName: 'Аккаунт',
    adminChip: 'Админ',
    readinessSteamOk: 'Steam привязан',
    readinessSteamNeed: 'Нужен Steam',
    readinessTradeUrlOk: 'Trade URL готов',
    readinessTradeUrlNeed: 'Нужен Trade URL',
    tradeUrlTitle: 'Trade URL',
    tradeUrlNeeded: 'Нужен для обменов в Steam — без него нельзя принимать и отправлять офферы.',
    tradeUrlStatusReady: 'Готов',
    tradeUrlStatusNeed: 'Не заполнен',
    ...
    saveTradeUrl: 'Сохранить',
    savingTradeUrl: 'Сохранение…',
    tradeUrlSaved: 'Ссылка на обмен сохранена.',
    getTradeUrl: 'Открыть в Steam',
    steamSectionTitle: 'Steam',
    steamCardLead: 'Инвентарь и сделки привязаны к этому аккаунту.',
    steamStatusLinked: 'Привязан',
    steamStatusNeed: 'Не привязан',
    ...
    quickLinksLead: 'Каталог, инвентарь и кошелёк — рядом.',
    quickCatalog: 'Каталог',
    quickInventory: 'Инвентарь',
    quickWallet: 'Кошелёк',
    name: 'Имя',
    role: 'Роль',
    status: 'Статус',
  ...
  support: {
    title: 'Поддержка',
    subtitle:
      'Опишите проблему — команда ответит здесь или на email. Типовые вопросы — в FAQ.',
    trustTitle: 'Мы на связи по деньгам и Steam-сделкам',
    trustBody:
      'Укажите тему и ID сделки, если есть — так быстрее разберёмся. Скрин можно приложить ссылкой.',
    openFaq: 'Открыть FAQ',
    ...
    attachmentHint:
      'Вложения пока не принимаем на сайте — вставьте ссылку на скрин (Imgur и т.п.) в описание.',
    ...
    topicHint: {
      deal: 'Укажите ID сделки и статус (ожидает обмен / спор / отмена).',
      deposit: 'Сумма, сеть/способ и время перевода помогут быстрее найти платёж.',
      withdrawal: 'Адрес, сумма и статус заявки на вывод — ключевые детали.',
      listing: 'Название предмета и что мешает выставить (Trade URL, lock, ошибка).',
      extension: 'Версия Chrome и что именно не срабатывает при автообмене.',
      account: 'Проблема с Steam, Trade URL или входом — опишите шаг, на котором застряли.',
      other: 'Любая другая проблема — чем конкретнее, тем быстрее ответ.',
    },
  },
  item: {
    type: 'Тип',
  ...
  orders: {
    ...
    emptyFilteredTitle: 'Нет сделок по фильтру',
    emptyFilteredMessage: 'Сбросьте статус или роль — активные сделки могут быть в другом разделе.',
    resetStatusFilter: 'Сбросить фильтр',
  ...
  orderNextAction: {
    ...
    disputeBody:
      'Закрыть спор может только поддержка или админ. Опишите ситуацию в тикете — деньги в hold до решения.',
    ...
    tradeConfirmedBuyerDeliveryBody:
      'Платформа проверяет доставку (обмена Steam + инвентарь). Предмет должен быть у вас — ничего делать не нужно.',
    tradeConfirmedSellerBody: 'Ожидаем выплату на ваш кошелёк.',
    tradeConfirmedSellerDeliveryBody:
      'Платформа проверяет доставку (обмена Steam + инвентарь). Выплату откроем после подтверждения.',
    waitTitle: 'Ожидайте',
  ...
  extensionAwareBuy: {
    ...
    pairTitle: 'Подключите расширение для более безопасного принятия обмена',
    pairBody:
      'Необязательно: подключите сейчас, чтобы страница Steam сверила скин с заказом. Покупка работает и без этого.',
    installTitle: 'Установите расширение для более безопасного принятия обмена',
    installBody:
      'Необязательное расширение Chrome: щит и проверки на странице обмена Steam. Купить можно и без него.',
  },
  extensionAwareSell: {
