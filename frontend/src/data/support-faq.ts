  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        body:
          'Если ответа нет в FAQ — создайте тикет на этой странице (форма справа внизу на десктопе). Укажите ID сделки, опишите проблему и приложите скриншоты.\n\n' +
          'Для срочных вопросов можно написать на email поддержки — ссылка указана в форме тикета.',
      },
    ],
  },
];
