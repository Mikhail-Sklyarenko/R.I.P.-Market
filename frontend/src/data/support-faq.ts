    ...
    articles: [
      {
        ...
        keywords: ['кошелёк', 'usdt', 'пополнить', 'баланс', 'trc-20', 'usd'],
        body:
          'Откройте «Кошелёк» → вкладка «Пополнение». Укажите сумму в USD и выберите сеть (TRC-20, BEP-20 или ERC-20). На странице кассы оплатите только USDT в выбранной сети.\n\n' +
          'Минимальная сумма и предупреждения указаны на странице. На баланс зачисляется USD по курсу кассы — это не фиксированный обмен 1 USDT = 1 USD. Обычно зачисление появляется через 5–15 минут после подтверждений сети.',
      },
      {
        id: 'wallet-hold',
        category: 'deposit',
      ...
      },
      {
        ...
        body:
          'Оплачивайте только в сети, которую выбрали при создании платежа. Перевод в другой сети не зачисляется автоматически и может быть потерян.\n\n' +
    ...
    articles: [
      ...
      },
      {
        ...
        body:
          ...
          'Цена указывается в USD. Цену активного лота можно изменить или снять с продажи из инвентаря или раздела «Мои лоты».',
      },
    ],
  },
  {
    ...
    articles: [
      {
        ...
        keywords: ['вывод', 'usdt', 'trc-20', 'кошелёк', 'usd'],
        body:
          'Откройте «Кошелёк» → вкладка «Вывод». Укажите сумму в USD и адрес для USDT. Средства спишутся с доступного USD-баланса; на адрес уйдёт USDT после проверки.\n\n' +
